...
const io = new Server(httpServer, {
  cors: {
    origin: ["http://localhost:3000", "http://localhost:4173", "https://6znr3gxn-4173.inc1.devtunnels.ms","https://6znr3gxn-3000.inc1.devtunnels.ms"],
...
io.on("connection", (socket) => {
  ...
  socket.on(
    ...
    (payload: { signal: any; userToSignal: string; callerID: string }) => {
      ...
      console.log(`Server: ${payload.callerID} inviting ${payload.userToSignal}`)
